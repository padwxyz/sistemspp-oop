...
public class lihatdata_page extends javax.swing.JFrame {
    Connection cn;
    Statement stmt;
    ResultSet rs;
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIS", "Nama Lengkap", "Alamat Lenkap", "Jenis Kelamin", "No. Telp", "Email", "Jurusan", "Kelas"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lihatdata_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lihatdata_page().setVisible(true);
            }
        });
    }
